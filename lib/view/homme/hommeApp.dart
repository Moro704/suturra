        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.circlePlus), label: "Home"),
              BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.bagShopping), label: "Home"),
              BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.circleUser), label: "Home"),
